...
--
-- Host: 127.0.0.1
-- Creato il: Apr 24, 2024 alle 09:34
...
INSERT INTO `brands` (`id`, `name`, `country`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Mercedes', 'Germania', NULL, NULL, NULL),
(2, 'BMW', 'Germania', NULL, NULL, NULL),
(3, 'Ford', 'USA', NULL, NULL, NULL),
(4, 'Fiat', 'Italia', NULL, NULL, NULL);
...
INSERT INTO `cars` (`id`, `name`, `hp`, `brand_id`, `created_at`, `updated_at`) VALUES
(1, 'GLA', '150', 1, NULL, NULL),
(2, 'Mondeo', '160', 3, NULL, NULL),
(3, 'Classe B', '110', 1, NULL, NULL),
(4, 'Punto', '90', 4, NULL, NULL),
(5, 'Classe A', '130', NULL, '2024-04-18 07:11:26', '2024-04-18 07:13:35');
...
(5, '2024_04_18_074430_create_brands_table', 1),
(6, '2024_04_18_074635_create_cars_table', 1);
