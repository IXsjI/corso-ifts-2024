...
class Contatto {
    constructor(nome, cognome, numeroTelefono,email) {
        this.nome = nome;
...
class Rubrica {
    ...
    stampaContatti(ordinamento) {
        ...
        for (let index = 0; index < this.elencoContatti.length; index++) {
            ...
            this.creaColonna(riga, contatto.email);
            this.creaColonna(riga, );
    ...
    creaColonna(tagRiga, valoreColonna) {
        let tagColonna = document.createElement("div");
        tagColonna.className = "col-md"
